    ...
    >
      <div className="space-y-6 text-center text-slate-100">
        ...
        <h2 className="text-3xl font-semibold sm:text-4xl">
          {needsRetry ? 'Think again about your decision' : 'A special moment begins'}
        </h2>
        <p className="mx-auto max-w-2xl text-slate-200/90 leading-8">
          {needsRetry
            ? 'This surprise only opens when your heart says yes.'
            : 'Answer the first question to unlock the next chapter of the surprise.'}
        </p>
